...
The format is loosely based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/); this project doesn't follow strict semantic versioning since it has no tagged releases yet.
